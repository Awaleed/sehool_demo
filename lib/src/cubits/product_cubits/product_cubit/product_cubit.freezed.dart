...
// ignore: unused_element
  _Success success(List<ProductModel> values) {
    return _Success(
      values,
    );
  }
...
mixin _$ProductState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult success(List<ProductModel> values),
    @required TResult failure(String message),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult loading(),
    TResult success(List<ProductModel> values),
...
abstract class _$SuccessCopyWith<$Res> {
  ...
  $Res call({List<ProductModel> values});
}
...
class __$SuccessCopyWithImpl<$Res> extends _$ProductStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_Success(
      values == freezed ? _value.values : values as List<ProductModel>,
    ));
  }
}
...
abstract class _Success implements ProductState {
  const factory _Success(List<ProductModel> values) = _$_Success;
