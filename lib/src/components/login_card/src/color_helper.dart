...
List<Color> getDarkShades(Color color, [ColorShade minShade = ColorShade.fifthLightest]) {
  ...
  return darkShades.isNotEmpty ? darkShades : [materialColor[shades[ColorShade.darkest]]];
}
